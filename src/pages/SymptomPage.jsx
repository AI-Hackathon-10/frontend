...
export default function SymptomPage() {
  ...
  return (
    <div className="page page--symptoms">
      ...
      <section className="symptom-document-action" aria-label="증상 문서 만들기"><button className="button button--primary button--wide" disabled={selectedSymptoms.length === 0} onClick={handleCreateDocument} type="button"><Icon name="notes" size={18} /> 증상 문서 만들기</button><p>작성한 내용은 문서로 정리되어 마이페이지에서 확인할 수 있어요.</p></section>
