...
import VoiceRecommendPage from './pages/VoiceRecommendPage.jsx'
import ElderlyVoiceRecommendPage from './pages/ElderlyVoiceRecommendPage.jsx'
      ...
      <AppShell>
        <Routes>
          ...
          <Route element={<RequireAuth />}>
            ...
            <Route path="/identify/voice" element={<VoiceRecommendPage />} />
            <Route path="/elderly/voice" element={<ElderlyVoiceRecommendPage />} />
