const iconPaths = {
  ...
  heart: <><path d="M10 16.6S3.3 13 3.3 7.8A3.7 3.7 0 0 1 10 5.6a3.7 3.7 0 0 1 6.7 2.2C16.7 13 10 16.6 10 16.6Z" /><path d="M5.8 10h2l1-2.2 2 4.4 1-2.2h2.3" /></>,
  image: <><rect x="2.5" y="3" width="15" height="14" rx="2" /><circle cx="7" cy="7.3" r="1.2" /><path d="m4.5 14 3.3-3.2 2.4 2.2 2-1.8 3.3 2.8" /></>,
  info: <><circle cx="10" cy="10" r="7.5" /><path d="M10 9v5M10 6.3h.01" /></>,
  ...
  user: <><circle cx="10" cy="7" r="3.2" /><path d="M4.3 16.5a5.7 5.7 0 0 1 11.4 0" /></>,
}
